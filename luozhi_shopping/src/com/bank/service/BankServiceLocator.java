...
public class BankServiceLocator extends org.apache.axis.client.Service implements com.bank.service.BankService {
    ...
    private java.lang.String Bank_address = "http://139.155.2.182:80/bank1/services/Bank";
    ...
    public com.bank.service.Bank getBank(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bank.service.BankSoapBindingStub _stub = new com.bank.service.BankSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bank.service.Bank.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bank.service.BankSoapBindingStub _stub = new com.bank.service.BankSoapBindingStub(new java.net.URL(Bank_address), this);
                _stub.setPortName(getBankWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.bank.com", "BankService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.bank.com", "Bank"));
        }
